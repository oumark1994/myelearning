...
<main id="main" class="main">
    ...
    <section class="section dashboard">
      ...
      <div class="col-lg-8 mt-5 offset-2 ">
        ...
        <form class="row justify-center g-3" enctype="multipart/form-data" action="{{url('update.category/'.$category->id)}}" method="post">
            @csrf
            @method('PUT')
            ...
            <div class="col-md-10 my-3">
              <img width="100%" height="250px" src="{{asset('images/'.$category->image)}}"/>
